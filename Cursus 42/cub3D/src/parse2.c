...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/21 14:55:51 by hwindom           #+#    #+#             */
/*   Updated: 2020/10/27 09:51:30 by hwindom          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	parse_resolution(t_config *config, char *line)
{
	...
	width = 0;
	height = 0;
	mlx_get_screen_size(config, &width1, &height1);
	...
	config->width = width1 > width ? width : width1;
	config->height = height1 > height ? height : height1;
	return (1);
}
